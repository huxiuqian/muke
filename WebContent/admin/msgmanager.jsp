	...
	function getMsg(pageNum){
		$.ajax({
			...
			success : function(data) {
					...
					page = setPage(pageNum, data.totalPage, "getMsg");
					//pageNum++;					
			}
		});
	}
		...
		<div class="row msglist template">
			...
			<div class="col-sm-8 col-xs-8">
				<div class="col-sm-8 col-xs-12 title">
					<a class="tit" target="_blank">标题</a>&nbsp;&nbsp; <span
						class="badge wonderful"></span> <span class="badge top"></span>
				</div>
				...
				<div class="modal-body">
					<form role="form">
						<div class="form-group">
							<label for="key">关键字：</label> <input type="text"
								class="form-control" id="key" placeholder="">
						</div>
						<div class="form-group">
